...
const Section2: React.FC<SectionProps> = ({ onBack }) => {
    ...
    return (
        <div className="h-full flex flex-col bg-gray-800/50 rounded-lg p-4 sm:p-6 shadow-xl border border-gray-700 relative">
            ...
            <div className="flex-shrink-0 mb-6 text-center">
                <h2 className="text-xl sm:text-2xl font-bold text-cyan-400">باحث ملفات PDF</h2>
            ...
            {searchHistory.length > 0 && (
                <div className="mb-6 flex flex-wrap items-center gap-2">
                    ...
                    {searchHistory.map(item => (
                         <div key={item} className="flex items-center bg-gray-700 rounded-full text-xs sm:text-sm group transition-colors duration-200">
                            <span 
                                className="px-3 sm:px-4 py-1 sm:py-1.5 text-cyan-400 cursor-pointer hover:bg-gray-600/70 rounded-l-full" 
                            ...
                            <button 
                                ...
                                className="px-2 sm:px-3 py-1 sm:py-1.5 text-gray-500 hover:text-white hover:bg-red-500/50 rounded-r-full transition-colors"
