...
const ApiKeyModal: React.FC<ApiKeyModalProps> = ({ onApiKeySubmit }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 border border-cyan-400/10 rounded-lg shadow-2xl p-6 sm:p-8 max-w-md w-full text-center transform transition-all animate-fade-in-up">
                <h2 className="text-xl sm:text-2xl font-bold text-cyan-400 mb-4">مطلوب مفتاح API</h2>
